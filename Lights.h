...
class Light{
public:
    virtual Color cast_on(const ColorBRDFMaterial &m, const Vec3 &originPos, const RayCastHit &rayHit) const =0;
...
public:
    ...
    Color cast_on(const ColorBRDFMaterial &m, const Vec3 &originPos, const RayCastHit &rayHit) const override;
