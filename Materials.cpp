...
Color LambertMaterial::get_color_from(const PointLight &pointLight, const Vec3 &cameraPos, const Vec3 &normal,
...
Color LambertMaterial::get_color_from(const DirectionalLight &directionalLight, const Vec3 &cameraPos,
                                      const Vec3 &normal, const Vec3 &rayHit) const {
...
Color LambertMaterial::get_color_from(const SpotLight &spotLight, const Vec3 &cameraPos, const Vec3 &normal,
                                      const Vec3 &rayHit) const {
...
Color BlinnPhongMaterial::get_color_from(const PointLight &pointLight, const Vec3 &cameraPos, const Vec3 &normal,
                                         const Vec3 &rayHit) const {
...
Color BlinnPhongMaterial::get_color_from(const SpotLight &spotLight, const Vec3 &cameraPos, const Vec3 &normal,
                                         const Vec3 &rayHit) const {
  Vec3 camVec = (cameraPos - rayHit).normalize();
  Vec3 lightVec = (rayHit - spotLight.position).normalize();
  Vec3 hVec = (camVec - lightVec).normalize();
